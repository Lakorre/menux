...
local MenuWindow = MachoMenuTabbedWindow("D3f4u1t1", MenuStartCoords.x, MenuStartCoords.y, MenuSize.x, MenuSize.y, TabsBarWidth)
...
MachoMenuButton(PlayerTabSections[1], "Super Jump (TX)", function()
